...
public class DESUtil {
    ...
    private final static String KEY = "manhuiFinance";

//    public static final String hjNumList=BankT
    ...
    public static String decryptDES(byte[] data, String key) throws Exception {
...
//        String enString = encrypt("440782198208183311");
//        System.out.println("加密后的字串是：" + enString);
//        String deString = decrypt("SVAeQpmf9m7ONVojidDqwWkVdOq9OSzz");
//        System.out.println("解密后的字串是：" + deString);
//
//        String reqUrl="https://ccdcapi.alipay.com/validateAndCacheCardInfo.json?_input_charset=utf-8&cardNo=#code#&cardBinCheck=true";
////        String deString="6230580000189999258";
//        String res=RequestHttpUtil.getContent(reqUrl.replace("#code#",deString));
//        System.out.println(res);
//        JSONObject jsonObject= JSON.parseObject(res);
//        String bankType=jsonObject.getString("bank");
